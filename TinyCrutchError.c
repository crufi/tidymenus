...
//
// STRIPPED copy of CrutchError.c -- Symantec C++ smart link doesn't drop unused
// functions, so this hand-stripped version exists to shrink the binary.  Removed
// (unused by this project):  ComplainInliningIsOff, Debug/Trace (DEBUG builds
// must use the full CrutchError.c), CToPStr, WeAreAMultiSegmentCodeResource,
// GetHandleToThisMultiSegmentCodeResource.  Re-strip after editing the original.
//
